  ...
  <nav class="bg-white fixed top-0 w-screen z-50 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    <div class="max-w-screen-xl border-b border-black flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
        <ul
          class="flex  flex-col space-x-4 font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <a href="#"
              class="block transition-all border-o bg-transparent duration-500 py-2 px-3 text-[#004443] hover:text-white hover:bg-[#00AEAA] px-5 hover:border hover:border-[#004443]  rounded-full"
          ...
          <li>
            <a href="#"
              class="block transition-all border-o bg-transparent duration-500 py-2 px-3 text-[#004443] hover:text-white hover:bg-[#00AEAA] px-5 hover:border hover:border-[#004443]  rounded-full">Services</a>
          </li>
          <li>
            <a href="#"
              class="block transition-all border-o bg-transparent duration-500 py-2 px-3 text-[#004443] hover:text-white hover:bg-[#00AEAA] px-5 hover:border hover:border-[#004443]  rounded-full">Pricing</a>
          </li>
          <li>
            <a href="#"
              class="block transition-all border-o bg-transparent duration-500 py-2 px-3 text-[#004443] hover:text-white hover:bg-[#00AEAA] px-5 hover:border hover:border-[#004443]  rounded-full">Contact</a>
          </li>
        </ul>
      </div>
      <div>
